...
class RuntimePackageLockTests(unittest.TestCase):
    ...
    def test_next_wave_candidate_is_bound_to_locally_validated_semantic_commit(self) -> None:
        self.assertEqual("07b2f586969f1be2ee8e9bf40bca09c1dfa6b395", runtime.SOURCE_COMMIT)
        self.assertEqual("0.0.0-packageplane.candidate.v20260925.4.sh07b2f586969f1", runtime.PACKAGE_VERSION)
