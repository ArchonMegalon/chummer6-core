...
class RuleAuthorityReviewerPacketTests(unittest.TestCase):
    def test_packets_reduce_review_work_to_bounded_checklists(self) -> None:
        ...
        self.assertEqual(20, sr4["estimated_review_time_minutes"])
        self.assertIn("Approve SR4", sr4["fast_path_summary"])
        self.assertEqual("approve", sr4["decision_table"][0]["decision"])
        ...
        self.assertEqual(30, sr6["estimated_review_time_minutes"])
        self.assertIn("Approve SR6", sr6["fast_path_summary"])
        self.assertEqual("approve + applied", sr6["decision_table"][0]["decision"])
