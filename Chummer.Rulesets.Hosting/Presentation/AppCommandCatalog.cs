...
public static class AppCommandCatalog
{
    ...
    private static IReadOnlyList<AppCommandDefinition> CreateSr5Catalog()
    {
        ...
        [
            ...
            Sr5("exit", "command.exit", "file", false, true),
            ...
            Sr5("auto_alice", "command.auto_alice", "tools", false, true),
            Sr5("new_character_origin", "command.new_character_origin", "tools", false, true),
            Sr5("global_settings", "command.global_settings", "tools", false, true),
            Sr5("switch_ruleset", "command.switch_ruleset", "special", false, true),
            ...
            Sr5("xml_editor", "command.xml_editor", "tools", false, true),
            Sr5("open_sourcebooks", "command.open_sourcebooks", "tools", false, true),
            Sr5("open_errata", "command.open_errata", "tools", false, true),
            Sr5("open_custom_data", "command.open_custom_data", "tools", false, true),
            Sr5("update_data_packs", "command.update_data_packs", "tools", false, true),
            Sr5("validate_data_scope", "command.validate_data_scope", "tools", false, true),
            Sr5("open_data_folder", "command.open_data_folder", "tools", false, true),
            ...
            Sr5("show_login_video", "command.show_login_video", "help", false, true),
