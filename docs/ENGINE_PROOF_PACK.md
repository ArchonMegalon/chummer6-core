...
- local git commit proof that the cited M104 guard commits, including guards `56048971`, `769e7259`, `d4b3b0ba`, `a2173476`, and `dafc1205`, resolve in this repository before the release-bound proof pack can pass
