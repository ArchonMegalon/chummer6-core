...
- local git commit proof that the cited M104 guard commits, including guards `56048971`, `769e7259`, and `d4b3b0ba`, resolve in this repository before the release-bound proof pack can pass
