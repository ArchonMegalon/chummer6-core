...
- local git commit proof that the cited M104 guard commits, including guard `b5571717`, resolve in this repository before the release-bound proof pack can pass
