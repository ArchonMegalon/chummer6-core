...
- local git commit proof that the cited M104 guard commits, including latest guard `220dd257`, resolve in this repository before the release-bound proof pack can pass
