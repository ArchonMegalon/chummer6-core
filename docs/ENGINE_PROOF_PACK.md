...
- local git commit proof that the cited M104 guard commits, including guard `56048971`, resolve in this repository before the release-bound proof pack can pass
