...
- local git commit proof that the cited M104 guard commits, including guards `56048971` and `769e7259`, resolve in this repository before the release-bound proof pack can pass
