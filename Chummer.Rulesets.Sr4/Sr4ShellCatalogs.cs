...
internal static class Sr4NavigationTabCatalog
{
    ...
    [
        Sr4("tab-create", "Create", "build-lab", "character", true, true),
        ...
        Sr4("tab-qualities", "Qualities", "qualities", "character", true, true),
        Sr4("tab-magician", "Magician", "spells", "character", true, true),
        Sr4("tab-combat", "Combat", "weapons", "character", true, true),
        Sr4("tab-gear", "Gear", "inventory", "character", true, true),
        Sr4("tab-cyberware", "Cyberware", "cyberwares", "character", true, true),
        Sr4("tab-adept", "Adept", "powers", "character", true, true),
        Sr4("tab-contacts", "Contacts", "contacts", "character", true, true),
...
internal static class Sr4WorkspaceSurfaceActionCatalog
{
    ...
    [
        Sr4("tab-create.intake", "Build Lab", "tab-create", WorkspaceSurfaceActionKind.Section, "build-lab", true, true),
        ...
        Sr4("tab-qualities.qualities", "Qualities", "tab-qualities", WorkspaceSurfaceActionKind.Section, "qualities", true, true),
        Sr4("tab-magician.spells", "Spells", "tab-magician", WorkspaceSurfaceActionKind.Section, "spells", true, true),
        Sr4("tab-magician.spirits", "Spirits", "tab-magician", WorkspaceSurfaceActionKind.Section, "spirits", true, true),
        Sr4("tab-magician.critterpowers", "Critter Powers", "tab-magician", WorkspaceSurfaceActionKind.Section, "critterpowers", true, true),
        Sr4("tab-combat.weapons", "Weapons", "tab-combat", WorkspaceSurfaceActionKind.Section, "weapons", true, true),
        Sr4("tab-combat.armors", "Armor", "tab-combat", WorkspaceSurfaceActionKind.Section, "armors", true, true),
        Sr4("tab-gear.inventory", "Inventory", "tab-gear", WorkspaceSurfaceActionKind.Section, "inventory", true, true),
        Sr4("tab-gear.drugs", "Drugs", "tab-gear", WorkspaceSurfaceActionKind.Section, "drugs", true, true),
        Sr4("tab-gear.vehicles", "Vehicles", "tab-gear", WorkspaceSurfaceActionKind.Section, "vehicles", true, true),
        Sr4("tab-cyberware.cyberwares", "Cyberware", "tab-cyberware", WorkspaceSurfaceActionKind.Section, "cyberwares", true, true),
        Sr4("tab-adept.powers", "Adept Powers", "tab-adept", WorkspaceSurfaceActionKind.Section, "powers", true, true),
        Sr4("tab-adept.complexforms", "Complex Forms", "tab-adept", WorkspaceSurfaceActionKind.Section, "complexforms", true, true),
        Sr4("tab-adept.aiprograms", "Programs", "tab-adept", WorkspaceSurfaceActionKind.Section, "aiprograms", true, true),
        Sr4("tab-adept.initiationgrades", "Initiation/Submersion", "tab-adept", WorkspaceSurfaceActionKind.Section, "initiationgrades", true, true),
        Sr4("tab-contacts.contacts", "Contacts", "tab-contacts", WorkspaceSurfaceActionKind.Section, "contacts", true, true),
