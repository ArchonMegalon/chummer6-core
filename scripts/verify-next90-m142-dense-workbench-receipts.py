...
PUBLISHED_RECEIPT_PATH = "/docker/chummercomplete/chummer-core-engine/.codex-studio/published/NEXT90_M142_DENSE_WORKBENCH_RECEIPTS.generated.json"
...
def build_payload(repo_root: Path, out_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "published_receipt_path": str((repo_root / ".codex-studio" / "published" / "NEXT90_M142_DENSE_WORKBENCH_RECEIPTS.generated.json").resolve()),
