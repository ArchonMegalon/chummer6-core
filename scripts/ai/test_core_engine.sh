...
release_channel_path="${CHUMMER_ENGINE_PROOF_RELEASE_CHANNEL:-$repo_root/tests/fixtures/engine-proof-pack/release-channel.public-stable.sanitized.json}"
...
python3 "$repo_root/scripts/generate-engine-proof-pack.py" \
  --repo-root "$repo_root" \
