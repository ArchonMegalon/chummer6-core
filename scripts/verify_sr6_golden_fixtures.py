...
REPORT = COMPLETION_ROOT / "SR6_GOLDEN_FIXTURES.generated.json"


def main() -> int:
    if not REPORT.is_file():
        print(json.dumps({"status": "fail", "reason": "missing SR6 fixture receipt"}, indent=2))
        return 1

    payload = json.loads(REPORT.read_text(encoding="utf-8"))
    ok = (
        payload.get("status") == "seed_fixtures_passed"
