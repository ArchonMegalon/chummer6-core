...
if [[ "$RUNBOOK_MODE" == "desktop-gate" ]]; then
  ...
  require_path "Chummer.Contracts/Chummer.Contracts.csproj"
  require_path "Chummer.Application/Chummer.Application.csproj"
  require_path "Chummer.Infrastructure/Chummer.Infrastructure.csproj"
  require_path "Chummer.Rulesets.Hosting/Chummer.Rulesets.Hosting.csproj"
  require_path "Chummer.Rulesets.Sr4/Chummer.Rulesets.Sr4.csproj"
  require_path "Chummer.Rulesets.Sr5/Chummer.Rulesets.Sr5.csproj"
  require_path "Chummer.Rulesets.Sr6/Chummer.Rulesets.Sr6.csproj"
  require_path "Chummer.Benchmarks/Chummer.Benchmarks.csproj"
  require_path "Chummer.Benchmarks/workspace-benchmark-budgets.json"
  require_path "Chummer.Benchmarks/MigrationWorkspaceBenchmarks.cs"
  require_path "scripts/generate-parity-checklist.sh"
  require_path "scripts/generate-engine-proof-pack.py"
  require_path "scripts/check-host-gate-prereqs.sh"
  require_path "scripts/runbook-strict-host-gates.sh"
  require_path "docs/NEXT90_M104_CORE_PROOF_PACK_CLOSEOUT.md"
  require_path "docs/ENGINE_PROOF_PACK.md"

  require_match "Chummer.Contracts\\\\Chummer.Contracts.csproj" "Chummer.CoreEngine.sln"
  require_match "Chummer.Application\\\\Chummer.Application.csproj" "Chummer.CoreEngine.sln"
  require_match "Chummer.Infrastructure\\\\Chummer.Infrastructure.csproj" "Chummer.CoreEngine.sln"
  require_match "Chummer.Rulesets.Sr4\\\\Chummer.Rulesets.Sr4.csproj" "Chummer.CoreEngine.sln"
  require_match "Chummer.Rulesets.Sr5\\\\Chummer.Rulesets.Sr5.csproj" "Chummer.CoreEngine.sln"
  require_match "Chummer.Rulesets.Sr6\\\\Chummer.Rulesets.Sr6.csproj" "Chummer.CoreEngine.sln"
  require_match "BenchmarkBudgetRunner.MeasureAndOptionallyCheck" "Chummer.Benchmarks/Program.cs"
  require_match "workspace.import.bastion" "Chummer.Benchmarks/MigrationWorkspaceBenchmarks.cs"
  require_match "workspace.section.skills.bastion" "Chummer.Benchmarks/MigrationWorkspaceBenchmarks.cs"
  require_match "workspace.save.bastion" "Chummer.Benchmarks/MigrationWorkspaceBenchmarks.cs"
  require_match "workspace.import.bastion" "Chummer.Benchmarks/workspace-benchmark-budgets.json"
  require_match "workspace.section.skills.bastion" "Chummer.Benchmarks/workspace-benchmark-budgets.json"
  require_match "workspace.save.bastion" "Chummer.Benchmarks/workspace-benchmark-budgets.json"
  require_match "dotnet run --project Chummer.Benchmarks/Chummer.Benchmarks.csproj -c Release -- --budget-check --budget-file Chummer.Benchmarks/workspace-benchmark-budgets.json" "docs/NEXT90_M104_CORE_PROOF_PACK_CLOSEOUT.md"
