...
REPORT_PATH = REPO_ROOT / ".codex-studio" / "published" / "SR6_RULE_AUTHORITY_INTEGRATION.generated.json"


def main() -> int:
    subprocess.run(
        [sys.executable, str(REPO_ROOT / "scripts" / "verify_sr6_rule_authority_seed.py")],
        cwd=REPO_ROOT,
        check=True,
    )
