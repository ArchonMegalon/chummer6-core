...
/// Modules simply because those methods serve a similar purpose.
/// </summary>
public static class Sr6CharacterCreationBuildMethods
{
    ...
    public static IReadOnlyList<string> All { get; } = Array.AsReadOnly(
        new[] { Priority, SumToTen, PointBuy, LifePath });

    public static bool IsKnown(string? buildMethod)
        => buildMethod is Priority or SumToTen or PointBuy or LifePath;
}
